...
//        }
    ...
    public static Set<Location> makeSphere(Location pos, double radiusX, double radiusY, double radiusZ, boolean filled){
        ...
        forX: for (int x = 0; x <= ceilRadiusX; ++x) {
            ...
            forY: for (int y = 0; y <= ceilRadiusY; ++y) {
                ...
                forZ: for (int z = 0; z <= ceilRadiusZ; ++z) {
                    ...
                    locations.add(new Location(pos.getWorld(), pos.getBlockX() + x, pos.getBlockY() + y, pos.getBlockZ() + z));
                    locations.add(new Location(pos.getWorld(), pos.getBlockX() - x, pos.getBlockY() + y, pos.getBlockZ() + z));
                    locations.add(new Location(pos.getWorld(), pos.getBlockX() + x, pos.getBlockY() - y, pos.getBlockZ() + z));
                    locations.add(new Location(pos.getWorld(), pos.getBlockX() - x, pos.getBlockY() - y, pos.getBlockZ() + z));
                    locations.add(new Location(pos.getWorld(), pos.getBlockX() + x, pos.getBlockY() + y, pos.getBlockZ() - z));

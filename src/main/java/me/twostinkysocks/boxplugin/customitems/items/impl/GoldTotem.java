...
public class GoldTotem extends CustomItem {

    private HashMap<UUID, Long> cooldown;

    public GoldTotem(CustomItemsMain plugin) {
        super(
                ChatColor.GOLD + "Golden Totem",
                "GOLD_TOTEM",
    ...
    public void totemPop(Player p){ 
        p.setHealth(Math.min(p.getAttribute(Attribute.MAX_HEALTH).getValue(), 10));

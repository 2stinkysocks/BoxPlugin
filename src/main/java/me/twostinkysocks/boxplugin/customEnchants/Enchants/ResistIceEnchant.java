...
public class ResistIceEnchant extends AbstractEnchant{
    private String enchantName;
    private NamespacedKey enchantKey;

    public ResistIceEnchant() {
        setEnchantName("Frost Resist");
        setEnchantKey(new NamespacedKey(BoxPlugin.instance, "FrostResist_enchant"));
    }

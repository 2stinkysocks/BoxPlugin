...
public class ResistPlantEnchant extends AbstractEnchant{
    private String enchantName;
    private NamespacedKey enchantKey;

    public ResistPlantEnchant() {
        setEnchantName("Nature Resist");
        setEnchantKey(new NamespacedKey(BoxPlugin.instance, "NatureResist_enchant"));
    }

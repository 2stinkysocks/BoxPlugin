...
public class ResistLightningEnchant extends AbstractEnchant{
    private String enchantName;
    private NamespacedKey enchantKey;

    public ResistLightningEnchant() {
        setEnchantName("Smite Resist");
        setEnchantKey(new NamespacedKey(BoxPlugin.instance, "LightningResist_enchant"));
    }
